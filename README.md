...
- Materials temporal + MLIP audit: `outputs/milestones/materials_temporal_mlip_audit/` (Week 1-4 follow-up from the frozen protocol; temporal t0/t1 validation remains no-go due missing timestamped snapshots, while frozen CHGNet/MACE-MP/ALIGNN-FF scores give pre-outcome release-vs-tail directional support without creating DFT evidence)
