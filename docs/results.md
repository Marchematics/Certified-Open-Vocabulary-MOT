...
release-core manifest: `contains_tuned_m_main_result=True`, `tuned_m_has_fallbacks=True`. Because fallback is used, the fixed-M table remains the safest main table for the current draft.
