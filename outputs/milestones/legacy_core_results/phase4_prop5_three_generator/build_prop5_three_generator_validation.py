...
ENTRIES = [
    ...
    },
    {
        ...
        "config": ROOT / "configs/phase4_ovtb_owlvit_matrix.yaml",
        "matrix": ROOT / "outputs/phase4_ovtb_owlvit/ovtb_alpha_seed_m_matrix.csv",
        "output_dir": ROOT / "outputs/phase4_ovtb_owlvit",
    },
    {
        "dataset": "TAO",
        "generator": "OWL-ViT v1",
        "config": ROOT / "configs/phase4_tao_owlvit_matrix.yaml",
        "matrix": ROOT / "outputs/phase4_tao_owlvit/tao_alpha_seed_m_matrix.csv",
        "output_dir": ROOT / "outputs/phase4_tao_owlvit",
    },
]
